...
target = r"D:\Dokumen\NgocAnh\FULLSTACK\graph-mind\frontend\src\components\ColorPaletteLandingPage.jsx"
with open(target, "w", encoding="utf-8") as f:
    f.write(total)
print("Wrote ColorPaletteLandingPage.jsx successfully! Total length:", len(total))
